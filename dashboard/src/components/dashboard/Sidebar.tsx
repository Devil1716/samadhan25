...
export default function Sidebar() {
  ...
  // Determine if we're in admin or client section
  const isAdmin = pathname?.includes('/dashboard/admin');
  const navItems = isAdmin ? adminNavItems : clientNavItems;

  return (
    <div className={`bg-indigo-800 text-white transition-all duration-300 ease-in-out ${collapsed ? 'w-16' : 'w-64'}`}>
      <div className="flex items-center justify-between h-16 px-4">
        {!collapsed && <h1 className="text-xl font-bold">SAMADHAAN</h1>}
        <button 
